...
namespace ImGui
{
    ...
    inline IMGUI_API bool DateChooser(const char* label, tm& dateOut, const char* dateFormat = "%d/%m/%Y",
    ...
    inline IMGUI_API void SetDateZero(tm* date);
    inline IMGUI_API void SetDateToday(tm* date);

    inline IMGUI_API void TestDateChooser(const char* dateFormat = "%d/%m/%Y", const char* leftArrow = "<",
                                    const char* rightArrow = ">", const char* upArrowString = "   ^   ",
                                    const char* downArrowString = "   v   ");
}
